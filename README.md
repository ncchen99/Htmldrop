...
把 HTML 檔案或靜態網站資料夾變成一個可以傳給別人的連結。丟進去、拿到網址、傳出去，沒有別的功能。

- **上傳頁**：<https://htm1drop.pages.dev>
- **單檔分享連結**：`https://pub-c8f72066867d4679a4095d2b9e00b1c6.r2.dev/m/k3f9a2b1cd`
- **資料夾分享連結**：`https://pub-c8f72066867d4679a4095d2b9e00b1c6.r2.dev/m/k3f9a2b1cd/index.html`
...
2. 把 `.html` 檔案或**靜態網站資料夾**（React/Vue 打包輸出的 `dist`、純 HTML/CSS/JS 資料夾）**直接拖進去**，或點選檔案/資料夾，也可以直接 **Ctrl/⌘+V 貼上 HTML 原始碼**。
